...
namespace CourseInfo {
    ...
    public partial class DBprojectDataSet : global::System.Data.DataSet {
        ...
        public partial class AttendanceDataTable : global::System.Data.TypedTableBase<AttendanceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public AttendanceRow AddAttendanceRow(string studentId, int courseId, System.DateTime aDate) {
...
namespace CourseInfo.DBprojectDataSetTableAdapters {
    ...
    public partial class AttendanceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Attendance] WHERE (([id] = @Original_id) AND ([studentId] = @O" +
                "riginal_studentId) AND ([courseId] = @Original_courseId) AND ([aDate] = @Origina" +
                "l_aDate))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Attendance] ([studentId], [courseId], [aDate]) VALUES (@studen" +
                "tId, @courseId, @aDate);\r\nSELECT id, studentId, courseId, aDate FROM Attendance " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Attendance] SET [studentId] = @studentId, [courseId] = @courseId, [aDate] = @aDate WHERE (([id] = @Original_id) AND ([studentId] = @Original_studentId) AND ([courseId] = @Original_courseId) AND ([aDate] = @Original_aDate));
SELECT id, studentId, courseId, aDate FROM Attendance WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CourseInfo.Properties.Settings.Default.DBprojectConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, studentId, courseId, aDate FROM dbo.Attendance";
        ...
        public virtual int Fill(DBprojectDataSet.AttendanceDataTable dataTable) {
        ...
        public virtual DBprojectDataSet.AttendanceDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DBprojectDataSet.AttendanceDataTable dataTable = new DBprojectDataSet.AttendanceDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBprojectDataSet.AttendanceDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_studentId, int Original_courseId, System.DateTime Original_aDate) {
        ...
        public virtual int Insert(string studentId, int courseId, System.DateTime aDate) {
            if ((studentId == null)) {
        ...
        public virtual int Update(string studentId, int courseId, System.DateTime aDate, int Original_id, string Original_studentId, int Original_courseId, System.DateTime Original_aDate, int id) {
            if ((studentId == null)) {
                throw new global::System.ArgumentNullException("studentId");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string studentId, int courseId, System.DateTime aDate, int Original_id, string Original_studentId, int Original_courseId, System.DateTime Original_aDate) {
            return this.Update(studentId, courseId, aDate, Original_id, Original_studentId, Original_courseId, Original_aDate, Original_id);
        }
    }
